...
/**
 * This is the item provider adapter for a {@link entities.Connection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ConnectionItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReferedPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EntitiesPackage.Literals.CONNECTION__NAME,
				 true,
				 false,
				 false,
	 ...
	 * @generated
	 */
	protected void addReferedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connection_refered_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connection_refered_feature", "_UI_Connection_type"),
				 EntitiesPackage.Literals.CONNECTION__REFERED,
				 true,
				 false,
				 true,
				 null,
